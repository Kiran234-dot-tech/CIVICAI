...
Would you like me to draft the specific "System Prompts" for the Gemini API to ensure the legal simplifications remain accurate when translated into these languages?